...
const filename = 'inventory_contract_template.xlsx';

// API DOWNLOAD TEMPLATE CONTRACT
const downloadTemplate = async () => {
  try {
    ...
    a.href = url;
    a.download = 'inventory_contract_template.xlsx';
...
const company_id = ref(props.companyId);
...
const submit = async () => {
  try {
    ...
    const response = await api.post('/api/contracts_import', formData);
