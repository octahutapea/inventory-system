    ...
    <div class="modal-content">
      <slot>
        <form @submit.prevent="submit" enctype="multipart/form-data">
          ...
          <div>
            <!-- <input class="mx-4 my-2 w-56 flex items-center p-2 border rounded-xl line-color" v-model="user_id" placeholder="User ID" /> -->
            ...
            <select class="mx-4 my-2 w-56 flex items-center p-2 border rounded-xl line-color" name="" id="" v-model="claim_location">
            ...
            <select class="mx-4 my-2 w-56 flex items-center p-2 border rounded-xl line-color" name="" id="" v-model="claim_status">
              <option disabled value="">Status</option>
              <option>Proses Admin</option>
              <option>Proses Manager</option>
              <option>Proses HC</option>
