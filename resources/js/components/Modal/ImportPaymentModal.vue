...
const filename = 'inventory_payment_template.xlsx';

// API DOWNLOAD TEMPLATE PAYMENT
const downloadTemplate = async () => {
  try {
    ...
    a.href = url;
    a.download = 'inventory_payment_template.xlsx';
...
const submit = async () => {
  try {
    ...
    const response = await api.post('/api/payment_import', formData);
