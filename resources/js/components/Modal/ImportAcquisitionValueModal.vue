...
const filename = 'inventory_acquisition_value_template.xlsx';

// API DOWNLOAD TEMPLATE ACQUISITION VALUE
const downloadTemplate = async () => {
  try {
    ...
    a.href = url;
    a.download = 'inventory_acquisition_value_template.xlsx';
...
const submit = async () => {
  try {
    ...
    const response = await api.post('/api/acquisition_value_import', formData);
